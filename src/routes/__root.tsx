...
import { SiteShell } from "@/components/bookmyscan/SiteShell";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BookMyScan.in | Radiology Scan Discovery" },
      ...
      { name: "author", content: "BookMyScan.in" },
      { property: "og:title", content: "BookMyScan.in" },
